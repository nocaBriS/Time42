 ...
 */
public class AmpelProgressBar extends View {


    /**
     * ProgressBar's line thickness
     */
    private float strokeWidth = 540;
    ...
    public void setStrokeWidth(float strokeWidth) {
        ...
        backgroundPaint.setStrokeWidth(backgroundPaint.getStrokeMiter());
        foregroundPaint.setStrokeWidth(backgroundPaint.getStrokeMiter());
        invalidate();
    ...
    public AmpelProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
