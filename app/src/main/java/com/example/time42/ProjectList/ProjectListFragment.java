...
public class ProjectListFragment extends Fragment {
    ...
    private ProjectListViewModel projectViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_projectlist, container, false);
        ...
        projectViewModel = new ViewModelProvider(this).get(ProjectListViewModel.class);
    ...
    private void bindAdapterToListView(ListView lv) {
        lv.setAdapter(new ProjectListAdapter(this.getContext(),
